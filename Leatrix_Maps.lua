	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 1.13.01 (18th June 2019, www.leatrix.com)
	----------------------------------------------------------------------
	...
	LeaMapsLC:MakeCB(PageF, "ShowIcons", "Show dungeon location icons", 16, -132, false)
