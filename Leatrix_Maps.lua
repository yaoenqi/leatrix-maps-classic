	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 1.13.02 (23rd June 2019, www.leatrix.com)
	----------------------------------------------------------------------
	...
	function LeaMapsLC:MainFunc()
		...
		tintFrame:SetSize(370, 310)
		tintFrame:SetFrameStrata("FULLSCREEN_DIALOG")
		tintFrame:SetFrameLevel(500)
		...
		tintFrame.mt:SetText(L["Revealed Tint"])
		...
		-- Add controls
		LeaMapsLC:MakeTx(tintFrame, "Red", 16, -72)
		LeaMapsLC:MakeSL(tintFrame, "tintRed", "", 0, 1, 0.1, 16, -92, "%.1f")

		LeaMapsLC:MakeTx(tintFrame, "Green", 16, -132)
		LeaMapsLC:MakeSL(tintFrame, "tintGreen", "", 0, 1, 0.1, 16, -152, "%.1f")

		LeaMapsLC:MakeTx(tintFrame, "Blue", 16, -192)
		LeaMapsLC:MakeSL(tintFrame, "tintBlue", "", 0, 1, 0.1, 16, -212, "%.1f")

		LeaMapsLC:MakeTx(tintFrame, "Transparency", 176, -192)
		LeaMapsLC:MakeSL(tintFrame, "tintAlpha", "", 0.1, 1, 0.1, 176, -212, "%.1f")

		LeaMapsLC:MakeTx(tintFrame, "Preview", 176, -72)
		tintFrame.preview = tintFrame:CreateTexture(nil, "ARTWORK")
		tintFrame.preview:SetSize(50, 50)
		tintFrame.preview:SetPoint("TOPLEFT", 176, -92)
	...
	function LeaMapsLC:MakeSL(frame, field, caption, low, high, step, x, y, form)
	...
	LeaMapsLC:MakeCB(PageF, "RevTint", "Tint revealed unexplored areas", 16, -112, false)

	LeaMapsLC:MakeTx(PageF, "Icons", 16, -152)
	LeaMapsLC:MakeCB(PageF, "ShowIcons", "Show dungeon location icons", 16, -172, false)

 	LeaMapsLC:CfgBtn("RevTintBtn", LeaMapsCB["RevTint"])
