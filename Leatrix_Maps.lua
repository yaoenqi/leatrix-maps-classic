	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 1.13.12 (12th August 2019, www.leatrix.com)
	----------------------------------------------------------------------
	...
	function LeaMapsLC:MainFunc()
		...
		do
			...
			LeaMapsLC:MakeSL(scaleFrame, "MapScale", "Scale", "", 0.5, 1, 0.05, 36, -142, "%.1f")
	...
	eFrame:SetScript("OnEvent", function(self, event, arg1)
		...
		if event == "ADDON_LOADED" and arg1 == "Leatrix_Maps" then
			...
			LeaMapsLC:LoadVarNum("MapScale", 0.9, 0.5, 1)				-- Map scale
