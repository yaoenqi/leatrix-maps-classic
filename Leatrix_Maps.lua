	...
	----------------------------------------------------------------------
	-- 	Leatrix Maps 1.13.22 (16th August 2019, www.leatrix.com)
	----------------------------------------------------------------------
	...
	function LeaMapsLC:MainFunc()
		...
		do
			...
			local PinData = {
				...
				[1422] =  --[[Western Plaguelands]] {{69.6, 73.1, L["Scholomance"], L["Dungeon"], dnTex},},
				...
				-- Kalimdor
				[1413] =  --[[The Barrens]] {{46.0, 36.4, L["Wailing Caverns"], L["Dungeon"], dnTex}, {42.6, 88.5, L["Razorfen Kraul"], L["Dungeon"], dnTex}, {50.0, 92.0, L["Razorfen Downs"], L["Dungeon"], dnTex},},
